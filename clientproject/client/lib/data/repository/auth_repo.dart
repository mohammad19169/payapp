...
class AuthRepo {
  ...
  Future<Response> loginWithSocialMedia(SocialLogInBody socialLogInBody,
      int timeout) async {
    return await apiClient.postData(
      ...
      if (!GetPlatform.isWeb) {
        ...
        if (isLoggedIn()) {
          FirebaseMessaging.instance.unsubscribeFromTopic(
              'zone_${Get.find<LocationController>().getUserAddress()!
                  .zoneId}_customer');
        }
      }
    }
  ...
  Future<Response> registerStore(StoreBody store, XFile? logo,
      XFile? cover) async {
  ...
  Future<Response> registerDeliveryMan(DeliveryManBody deliveryManBody,
