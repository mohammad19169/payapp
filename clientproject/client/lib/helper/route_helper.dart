...
import 'package:payapp/view/screens/digital_payment/digital_payment_screen.dart';
...
class RouteHelper {
  ...
  static List<GetPage> getAllRoutes(
    ...
    List<GetPage> routes = [
      GetPage(
          name: initial,
          page: () => getRoute(NavigationScreen(
                  languages: languages,
                  body: body,
                  pageIndex: 0,
      ...
      GetPage(
          name: search,
          page: () =>
              getRoute(SearchScreen(queryText: Get.parameters['query']))),
      GetPage(
          name: store,
          page: () {
            return getRoute(
      ...
      GetPage(
          name: cart, page: () => getRoute(const CartScreen(fromNav: false))),
      GetPage(
          name: addAddress,
      ...
      GetPage(
          ...
          page: () {
            ...
            return getRoute(
              SelectMapLocation(
                riderType: jsonDecode(utf8.decode(base64Url.decode(
                    Get.parameters['rider_type']!.replaceAll(' ', '+')))),
