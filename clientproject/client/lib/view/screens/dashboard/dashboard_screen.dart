...
import 'package:payapp/view/screens/dashboard/widget/bottom_nav_item.dart';
        ...
        return Scaffold(
          ...
          bottomNavigationBar: ResponsiveHelper.isDesktop(context)
              ...
              : (widget.fromSplash &&
                      Get.find<LocationController>().showLocationSuggestion &&
                      active)
                  ?  Container(child:const Text("Ddddddddd"))
                  : (orderController.showBottomSheet &&
                          orderController.runningOrderModel != null &&
                          orderController.runningOrderModel!.orders!.isNotEmpty)
                      ?  Container(child:const Text("Ddddddddd"))
          ...
          body: const Text('ExpandableBottomSheet is here'),
